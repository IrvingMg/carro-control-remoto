...
/*** PINES ***/
//Reset - PB3
#define LCD_RST_set  PORTB |=  (1<<3)    
#define LCD_RST_clr  PORTB &=~ (1<<3)
//Data/Coommand - PB2
#define LCD_DC_set   PORTB |=  (1<<2) 
#define LCD_DC_clr   PORTB &=~ (1<<2)
//Data input - PB1
#define SDIN_set     PORTB |=  (1<<1)   
#define SDIN_clr     PORTB &=~ (1<<1)
//CLK - PB0
#define SCLK_set     PORTB |=  (1<<0)    
#define SCLK_clr     PORTB &= ~(1<<0)
